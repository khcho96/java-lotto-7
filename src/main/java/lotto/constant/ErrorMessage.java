...
public enum ErrorMessage {
    ...
    CSV_FORMAT_ERROR("쉼표(,)를 기준으로 구분되는 입력이어야 합니다. 예) 1,2,3,4,5,6"),

    PURCHASE_AMOUNT_UNIT_ERROR("구입 금액은 1000원 단위여야 합니다."),
    PURCHASE_AMOUNT_RANGE_ERROR("구입 금액은 100,000원 이하여야 합니다."),
    ...
    BONUS_NUMBER_UNIQUE_ERROR("보너스 번호는 당첨 번호와 중복되자 않아야 합니다.");
