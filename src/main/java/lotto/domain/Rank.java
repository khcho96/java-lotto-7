...
public enum Rank {
    ...
    FIFTH(5_000L, "3개 일치 (5,000원) - %d개"),
    FOURTH( 50_000L, "4개 일치 (50,000원) - %d개"),
    THIRD( 1_500_000L, "5개 일치 (1,500,000원) - %d개"),
    SECOND(30_000_000L, "5개 일치, 보너스 볼 일치 (30,000,000원) - %d개"),
    FIRST(2_000_000_000L, "6개 일치 (2,000,000,000원) - %d개"),
    NONE(null, null);
